        ...
        <div class="panel-body">
            <form role="form" class="form-horizontal" action="_app/formValidator.php" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input id="nomservice" class="form-control" type="text" name="nomservice" placeholder="Entrer nom service">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea id="description" name="details" class="input-xlarge form-control" rows="3" placeholder="Description service"></textarea>

                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-10 col-sm-offset-2">
                        <button Type="submit" class="btn btn-primary" id="enregistrer" name="addService">Enregistrer</button>
